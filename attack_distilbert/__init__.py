...
import numpy as np
from transformers import BertConfig, BertTokenizerFast, BertForMaskedLM, DistilBertConfig, DistilBertTokenizerFast, DistilBertForMaskedLM
import torch
...
class BERTAttacker(ClassificationAttacker):
    ...
    def __init__(self, 
            mlm_path : str = 'distilbert-base-uncased',
            k : int = 36,
            use_bpe : bool = True,
        ...
        self.tokenizer_mlm = DistilBertTokenizerFast.from_pretrained(mlm_path, do_lower_case=True)
        ...
        self.mlm_model = DistilBertForMaskedLM.from_pretrained(mlm_path, config=config_atk).to(self.device)
    ...
    def attack(self, victim: Classifier, sentence, goal: ClassifierGoal):
        ...
        # original label
        inputs = tokenizer.encode_plus(feature.seq, None, add_special_tokens=True, max_length=max_length, truncation=True,return_attention_mask=True)
        ...
        for top_index in list_of_index:
            ...
            for substitute in substitutes:               
                ...
                inputs = tokenizer.encode_plus(temp_text, None, add_special_tokens=True, max_length=max_length, truncation=True,return_attention_mask=True)
